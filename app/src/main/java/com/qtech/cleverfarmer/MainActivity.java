...
public class MainActivity extends Activity {
    ...
    private final int GET_UNDATAINFO_ERROR = 2;   //获取服务器更新信息失败
    private final int DOWN_ERROR = 3;   //下载新版本失败
    private final int NEED_NOT_UPDATA = 4;      //不用更新
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn1 = (Button) findViewById(R.id.xuanze);
